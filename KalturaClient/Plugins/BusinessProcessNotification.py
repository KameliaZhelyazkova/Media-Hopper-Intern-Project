...
class KalturaBusinessProcessServerService(KalturaServiceBase):
    ...
    def add(self, businessProcessServer):
        """Allows you to add a new Business-Process server object"""

        kparams = KalturaParams()
        kparams.addObjectIfDefined("businessProcessServer", businessProcessServer)
        self.client.queueServiceActionCall("businessprocessnotification_businessprocessserver", "add", KalturaBusinessProcessServer, kparams)
        if self.client.isMultiRequest():
            return self.client.getMultiRequestResult()
        resultNode = self.client.doQueue()
        return KalturaObjectFactory.create(resultNode, KalturaBusinessProcessServer)
    ...
    def get(self, id):
        ...
        self.client.queueServiceActionCall("businessprocessnotification_businessprocessserver", "get", KalturaBusinessProcessServer, kparams)
        if self.client.isMultiRequest():
            return self.client.getMultiRequestResult()
        resultNode = self.client.doQueue()
        return KalturaObjectFactory.create(resultNode, KalturaBusinessProcessServer)

    def update(self, id, businessProcessServer):
        """Update an existing Business-Process server object"""

        kparams = KalturaParams()
        kparams.addIntIfDefined("id", id);
        kparams.addObjectIfDefined("businessProcessServer", businessProcessServer)
        self.client.queueServiceActionCall("businessprocessnotification_businessprocessserver", "update", KalturaBusinessProcessServer, kparams)
        if self.client.isMultiRequest():
            return self.client.getMultiRequestResult()
        resultNode = self.client.doQueue()
        return KalturaObjectFactory.create(resultNode, KalturaBusinessProcessServer)
    ...
    def updateStatus(self, id, status):
        ...
        self.client.queueServiceActionCall("businessprocessnotification_businessprocessserver", "updateStatus", KalturaBusinessProcessServer, kparams)
        if self.client.isMultiRequest():
            return self.client.getMultiRequestResult()
        resultNode = self.client.doQueue()
        return KalturaObjectFactory.create(resultNode, KalturaBusinessProcessServer)
    ...
    def delete(self, id):
        ...
        kparams = KalturaParams()
        kparams.addIntIfDefined("id", id);
        self.client.queueServiceActionCall("businessprocessnotification_businessprocessserver", "delete", None, kparams)
        if self.client.isMultiRequest():
            return self.client.getMultiRequestResult()
        resultNode = self.client.doQueue()
    ...
    def list(self, filter = NotImplemented, pager = NotImplemented):
        ...
        self.client.queueServiceActionCall("businessprocessnotification_businessprocessserver", "list", KalturaBusinessProcessServerListResponse, kparams)
        if self.client.isMultiRequest():
            return self.client.getMultiRequestResult()
        resultNode = self.client.doQueue()
        return KalturaObjectFactory.create(resultNode, KalturaBusinessProcessServerListResponse)
...
class KalturaBusinessProcessNotificationClientPlugin(KalturaClientPlugin):
    ...
    def getServices(self):
        return {
            'businessProcessServer': KalturaBusinessProcessServerService,

...
class KalturaIntegrationJobData(KalturaJobData):
    def __init__(self,
            callbackNotificationBaseUrl=NotImplemented,
        ...
        # @var string
        self.callbackNotificationBaseUrl = callbackNotificationBaseUrl
    ...
    PROPERTY_LOADERS = {
        'callbackNotificationBaseUrl': getXmlNodeText, 
    ...
    def toParams(self):
        ...
        kparams.addStringIfDefined("callbackNotificationBaseUrl", self.callbackNotificationBaseUrl)
    ...
    def getCallbackNotificationBaseUrl(self):
        return self.callbackNotificationBaseUrl

    def setCallbackNotificationBaseUrl(self, newCallbackNotificationBaseUrl):
        self.callbackNotificationBaseUrl = newCallbackNotificationBaseUrl
